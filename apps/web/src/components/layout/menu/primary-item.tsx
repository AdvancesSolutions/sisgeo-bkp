    ...
    <>
      {menuType === MenuType.Comfort && (
        ...
        >
          ...
          <Box className="flex w-full justify-center px-0.5">
            <Typography
              variant="body2"
              component="span"
              className={cn(
                "text-text-primary line-clamp-2 text-center font-semibold transition-all",
        ...
        <Box className={cn("group flex w-11 flex-col items-center gap-2", className)}>
          ...
          >
            <Button
              ...
              className={cn(
                "icon-only hover:bg-grey-25 text-text-primary h-11 w-11 min-h-11 min-w-11",
                selected &&
              ...
              startIcon={
                item.icon ? (
                  <Box className="flex h-6 w-6 shrink-0 items-center justify-center" aria-hidden>
                    <NextureIcons
                      variant={selected ? "contained" : "outlined"}
                      icon={item.icon}
                      size={24}
